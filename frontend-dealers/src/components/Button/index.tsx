...
const Button = ({
  ...
  const baseStyles =
    "inline-flex items-center justify-center rounded-lg font-medium cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
  const variantStyles = {
    outlined:
      "shadow-sm border-gray-300 bg-transparent text-gray-900 hover:border-slate-400 hover:bg-slate-50 focus:ring-slate-400",
    filled:
      "border-0 bg-[#0f1117] text-white hover:bg-[#1e2330] focus:ring-[#0f1117]",
    contained:
  ...
  const sizeStyles = {
    ...
    md: "py-2.5 px-5 text-base gap-3",
