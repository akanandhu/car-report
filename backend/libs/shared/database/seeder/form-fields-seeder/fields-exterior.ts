...
export const EXTERIOR_FIELDS = [
  ...
  ...extPart(
    ...
    'headlight_support',
    6,
    ['Good', 'Welded', 'Clamped', 'Damaged', 'Repaired', 'Other'],
    false,
  ),
  ...extPart('Front Windshield', 'front_windshield', 8, [
    'Good',
    'Scratched',
    'Damaged',
    'Rusted',
  ...
  ...extPart(
    ...
    'fog_lamp',
    20,
    ['Working', 'Not Working', 'Not Available', 'Damaged'],
    false,
  ),

  // ── Front Right ──────────────────────────────────────────────
  imgField('Front Right Image', 'front_right_image', 22),
  ...extPart('RH-Fender', 'rh_fender', 23, [
    'Good',
    'Replaced',
    'Repainted',
    'Rusted',
  ...
  {
    type: 'radio',
    label: 'Tyre Front RHS',
    fieldKey: 'tyre_front_rhs',
    isRequired: true,
    order: 27,
    options: opts(TYRE_CONDITIONS),
  },
  ...
  ...extPart('RH-Quarter Panel', 'rh_quarter_panel', 43, [
    'Good',
    'Replaced',
    'Repainted',
    'Rusted',
  ...
  ...extPart(
    ...
    'chassis_extension',
    45,
    ['Welded', 'Replaced', 'Repaired', 'Damaged', 'Rusted', 'Other'],
    false,
  ),
  {
    type: 'radio',
    label: 'Tyre Rear RHS',
    fieldKey: 'tyre_rear_rhs',
    isRequired: true,
    order: 47,
    options: opts(TYRE_CONDITIONS),
  },
  ...
  ...extPart('Fuel Lid', 'fuel_lid', 51, [
    'Good',
    'Damaged',
    'Rusted',
    'Other',
  ]),
  ...extPart('Dicky Door', 'dicky_door', 53, [
    'Good',
    'Replaced',
    'Repainted',
    'Repaired',
  ...
  ...extPart('Rear Windshield', 'rear_windshield', 55, [
    'Good',
    'Scratched',
    'Damaged',
    'Not Available',
  ...
  },
  {
    type: 'radio',
    label: 'Jack & Tool',
    fieldKey: 'jack_and_tool',
    isRequired: true,
    order: 68,
    options: opts(['Yes', 'No']),
  },
  ...extPart('LH-C Pillar', 'lh_c_pillar', 69, PILLAR_CONDITIONS),
  ...extPart('LH Quarter Panel', 'lh_quarter_panel', 71, [
    'Good',
    'Scratched',
    'Dented',
    'Damaged',
  ...
  ...extPart('LH Running Board', 'lh_running_board', 78, [
    'Good',
    'Replaced',
    'Repainted',
    'Rusted',
  ...
  {
    type: 'radio',
    label: 'Tyre Front LHS',
    fieldKey: 'tyre_front_lhs',
    isRequired: true,
    order: 89,
    options: opts(TYRE_CONDITIONS),
  },
  ...
  ...extPart('LH Fender', 'lh_fender', 92, [
    'Good',
    'Scratched',
    'Dented',
    'Damaged',
  ...
  // Cowl Top – no "Good" option, multi-select without Good-lock rule
  {
    ...
    isRequired: false,
    order: 103,
    options: opts(['Damaged', 'Repainted', 'Repaired', 'Rusted', 'Other']),
  },
  ...
  ...extPart(
    ...
    'firewall',
    105,
    ['Good', 'Damaged', 'Repaired', 'Rusted', 'Repainted', 'Other'],
    false,
  ),
  ...extPart('Rear Wiper', 'rear_wiper', 107, [
    'Good',
    'Damaged',
    'Replaced',
    'Not Available',
