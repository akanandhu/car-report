...
async function main() {
  ...
  try {
    ...
    // Seed Indian states and RTO reference data
    console.log('🚗 Seeding RTO reference data...');
    await RtoSeeder.seed(prisma);
    console.log('✅ RTO reference data seeded successfully\n');
