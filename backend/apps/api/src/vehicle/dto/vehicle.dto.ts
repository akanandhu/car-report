...
export const VEHICLE_LIST_STATUSES = ['draft', 'completed'] as const;

export type VehicleListStatus = (typeof VEHICLE_LIST_STATUSES)[number];
...
/**
 * Query DTO for listing vehicles
 */
