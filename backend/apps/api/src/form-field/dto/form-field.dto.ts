...
export class CreateFormFieldDto {
  ...
  @ApiPropertyOptional({
    description:
      'Optional visual subgroup label used to group fields inside a step',
    example: 'Seller Info',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description:
      'API endpoint URL for paginated/dynamic options (used instead of options)',
  ...
  @ApiPropertyOptional({
    description:
      'Conditional display rules. Simple: { dependsOn, operator, value, action } or Complex: { logic, action, rules: [...] }',
    example: {
...
export class FormFieldResponseDto {
  ...
  @ApiPropertyOptional() validation?: Prisma.JsonValue;
  @ApiPropertyOptional() options?: Prisma.JsonValue;
  @ApiPropertyOptional() endpoint?: string;
  @ApiPropertyOptional() conditions?: Prisma.JsonValue;
...
export class FormConfigResponseDto {
  ...
  @ApiProperty({ type: [FormFieldGroupResponseDto] })
  fieldGroups!: FormFieldGroupResponseDto[];
}
